...
<h1>Nuevo Informe Pre Operatorio <small>${nombre}</small>
        </h1>
        <div class="content">
			<form role="form" class="form-horizontal" method="post" action="Servlet?v=guardarInfoPre&idpac=${idpac}">
...
<!--              <label class="col-sm-1 control-label">Piso
            ...
            <div class="form-group">
              ...
              <div class="col-sm-1">
                <input class="form-control input-sm tar" name="cantidad">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-1">
                <input class="form-control input-sm" name="IniAnest" id="IniAnest">
              </div>
              <label class="col-sm-1 control-label">Fin
              </label>
              <div class="col-sm-1">
                <input class="form-control input-sm" name="FinAnest" id="FinAnest">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input class="form-control input-sm" name="FechaInterv" id="FechaInterv">
              </div>
            </div>
            <div class="form-group">
