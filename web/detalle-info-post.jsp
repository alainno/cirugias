...
<div class="content">
	...
	<div class="mt10">
		<a href="Servlet?v=detallePaciente&id=${detaoper.paciente.idPaciente}" class="btn btn-primary btn-sm">Detalles del Paciente</a>
		<a href="Servlet?v=modificarInfoPost&id=${detaoper.idDetalleOper}" class="btn btn-warning btn-sm ml10">Modificar Informe</a>
		<a href="#" class="btn btn-default btn-sm ml10">Imprimir Detalles</a>
	</div>
			<p></p>
</div>
